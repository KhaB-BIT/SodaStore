...
__webpack_require__(/*! ./map-custom */ "./resources/js/map-custom.js"); // require('./slick-custom');
  ...
  $('.js-show-modal1').on('click', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        var modalImage = document.getElementById('modal_product_image');
        modalImage.innerHTML = "\n                <div class=\"item-slick3\" data-thumb=\"".concat(response.data.image, "\">\n                    <div class=\"wrap-pic-w pos-relative\">\n                        <img src=\"").concat(response.data.image, "\" alt=\"IMG-PRODUCT\">\n                        <a class=\"flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04\" href=\"").concat(response.data.image, "\">\n                            <i class=\"fa fa-expand\"></i>\n                        </a>\n                    </div>\n                </div>"); // Choose Size and Color

        $('#modal_product_size').on('change', function () {
          console.log(123);
          var boxSize = document.getElementById('modal_product_size');
          var selectedSize = boxSize.options[boxSize.selectedIndex].value;
          var variantData = response.variant;
          var boxColor = document.getElementById('modal_product_color');
          boxColor.innerHTML = "<option selected disabled>Ch\u1ECDn m\xE0u s\u1EAFc</option>";
          variantData.forEach(function (item) {
            if (item.size == selectedSize) {
              boxColor.innerHTML = "<option value=\"".concat(item.color, "\">").concat(item.color, "</option>");
            }
          });
        });
      },
